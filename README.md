...
<p align="center">
  ...
  🔓 突破频道限制 — 支持下载<b>禁止转发/保存</b>频道的视频<br>
  监听「已保存消息」，自动下载视频和文档，支持断点续传、查重去重<br>
...
| 功能 | 说明 |
|---|---|
| 🔓 **禁止转发频道下载** | 🎯 **核心卖点！** 频道设置了禁止转发/禁止保存？直接把消息链接发到「已保存消息」，Bot 自动抓取下载 |
...
> ### 🔓 禁止转发的频道也能下载
>
> 这是本项目**最大的亮点**。很多 Telegram 频道设置了「禁止转发」或「禁止保存消息」，
> 普通方式根本无法下载里面的视频。本 Bot 通过 **t.me 消息链接直接抓取**，绕过转发限制：
>
> 1. 在频道中找到你要下载的视频，点右上角 → **复制消息链接**
> 2. 把链接粘贴到你的「已保存消息」发出去
> 3. Bot 自动解析链接 → 直接通过消息 ID 抓取 → 保存到本地
>
> 无需转发、无需保存、频道根本不知道你在下载。**只要有链接，就能下。**
...
**Q: 怎么用 t.me 链接下载「禁止转发」频道的视频？**

A: 很简单。在频道中找到视频消息 → 点右上角「分享」→「复制消息链接」→ 把链接发到你的「已保存消息」，Bot 会自动解析并下载。**不需要转发、不需要保存、频道不会收到任何通知。**

**Q: 所有链接都能下载吗？**

A: 只要是你账号**能访问**的公开频道或群组，链接都可以解析。私密频道需要你的账号先加入该频道。
